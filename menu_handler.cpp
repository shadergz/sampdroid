...
namespace samimic {
    [[maybe_unused]] static void OnMultiplayer_buttonPressed()
    {
        ...
        salog::printFormat(ANDROID_LOG_INFO, "Multiplayer button selected from menu at %s, enjoy!", tMsg);
    }
}
...
namespace samimic {
    ...
    static void menu_placeButton(const char* btName, const char fep[8], MainMenuScreen* menu)
    {
        ...
        if (!menu->m_slot) {
            ...
            memset(menu->m_slot, 0xf, sizeof (MenuSlot) * SLOT_MAX_COUNT);
        ...
        salog::printFormat(ANDROID_LOG_INFO, "Free slot selected: %llx\n", slotPtr);
    ...
    void MainMenuScreen_AddAllItems(uintptr_t this_x0)
    {
        ...
        */
        ...
        MainMenuScreen* ourInGameMenu{reinterpret_cast<MainMenuScreen*>(this_x0)};
